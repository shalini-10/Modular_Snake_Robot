...
public:
  AprilTagNode() : 
    ...
    tag_detector(NULL),
    camera_focal_length_y(803.9),//700),
    camera_focal_length_x(803.9),//700),
    tag_size(0.02), // 1 1/8in marker = 0.029m
    show_debug_image(false)
  {
    ...
    private_node_handle.param<double>("focal_length_px", camera_focal_length_x, 803.9);
    private_node_handle.param<double>("tag_size_cm", tag_size, 2);
