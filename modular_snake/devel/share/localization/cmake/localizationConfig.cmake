...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/shalini/projects/modular_snake/src/localization)
  set(localization_DEVEL_PREFIX /home/shalini/projects/modular_snake/devel)
  ...
  set(localization_INSTALL_PREFIX /home/shalini/projects/modular_snake/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'shalini <shalini@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shalini/projects/modular_snake/src/localization/${idir}'.  Ask the maintainer 'shalini <shalini@todo.todo>' to fix it.")
    endif()
