...
if("FALSE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/pi/Modular_Snake_Robot/snake_robot_ws/src/apriltags)
  set(apriltags_DEVEL_PREFIX /home/pi/Modular_Snake_Robot/snake_robot_ws/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/pi/Modular_Snake_Robot/snake_robot_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'vinit <vinit@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/Modular_Snake_Robot/snake_robot_ws/install/${idir}'.  Ask the maintainer 'vinit <vinit@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/Modular_Snake_Robot/snake_robot_ws/install/lib;/home/pi/ros_ws/devel/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(apriltags_EXPORTED_TARGETS "apriltags_generate_messages_cpp;apriltags_generate_messages_lisp;apriltags_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${apriltags_dep}_FOUND)
      find_package(${apriltags_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${apriltags_dep} REQUIRED ${depend_list})
  endif()
